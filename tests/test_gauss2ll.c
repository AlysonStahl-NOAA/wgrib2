...
main(){
    ...
    printf("Test Case 2: Quasi-regular Gaussian lat-lon grid.\n");
    {
         ...
         * for the gauss2ll() function. The intention of the input values selected
         ...
         * also result in as many "branches" of the code being executed as possible. Unlike the previous
         * case (test case 1), this case should cover quasi-regular grids. In other words, the following if 
         * statement should execute as FALSE, executing the else branch:
         * if (nnx_ > 0)
         * 
